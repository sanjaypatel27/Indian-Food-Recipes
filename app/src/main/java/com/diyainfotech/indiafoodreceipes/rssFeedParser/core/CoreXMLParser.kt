package com.diyainfotech.indiafoodreceipes.rssFeedParser.core
...
import com.diyainfotech.indiafoodreceipes.rssFeedParser.Image
import com.diyainfotech.indiafoodreceipes.rssFeedParser.RSSKeywords
    ...
    fun parseXML(xml: String): Channel {
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (xmlPullParser.name.equals(RSSKeywords.RSS_CHANNEL, ignoreCase = true) || xmlPullParser.name.equals(RSSKeywords.RSS_FEED, ignoreCase = true) ) {
                    insideChannel = true

                } else if (xmlPullParser.name.equals(RSSKeywords.RSS_ITEM, ignoreCase = true) || xmlPullParser.name.equals(RSSKeywords.RSS_ENTRY, ignoreCase = true)) {
                    insideItem = true
                ...
                } else if (xmlPullParser.name.equals(RSSKeywords.RSS_ITEM_MEDIA_CONTENT, ignoreCase = true) || xmlPullParser.name.equals(RSSKeywords.RSS_ITEM_MEDIA_GROUP, ignoreCase = true) ) {
                    if (insideItem) {
                        currentArticle.image = xmlPullParser.getAttributeValue(null, RSSKeywords.RSS_ITEM_URL)
                    }
            ...
            } else if (eventType == XmlPullParser.END_TAG && (xmlPullParser.name.equals(RSSKeywords.RSS_ITEM, ignoreCase = true) || xmlPullParser.name.equals(RSSKeywords.RSS_ENTRY, ignoreCase = true))) {
                // The item is correctly parsed
                insideItem = false
                articleList.add(currentArticle)
                currentArticle = Article()
            } else if (eventType == XmlPullParser.END_TAG && (xmlPullParser.name.equals(RSSKeywords.RSS_CHANNEL, ignoreCase = true) || xmlPullParser.name.equals(RSSKeywords.RSS_FEED, ignoreCase = true))) {
